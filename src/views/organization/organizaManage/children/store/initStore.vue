<style lang="less" scoped>
  @import "./initStore.less";
</style>
<template>
  <transition name="fade">
    <div class="init-store-container tzx-slide-right-window-container">
      <div class="body" ref="slideRightBody">
        <div class="head">
          <h3 class="title">门店初始化</h3>
...
<script>
  ...
  export default {
    ...
    mounted () {
      if (this.showInitStore) {
        this.showBody()
      }
    },
    props: ['organiza', 'showInitStore'],
    data () {
      return {
        defaultProps: {
          children: 'children',
